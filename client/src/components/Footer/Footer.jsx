  ...
  return (
    <FooterElement>
      <div className="container">
        <div className="row">
          <div className="col">
            ...
            <div className="col-body">
              <ul>
                <li>
                  Designed and built with all the love in the world by Sumit using react.js.
                </li>
          ...
          <div className="col">
            ...
            <div className="col-body">
              <ul>
                <li>
                  <a
                    href="https://github.com/sumit87814"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/sumit-rai-bb10a0211/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    LinkedIn
        ...
        <div className="credits">© 2023 Sumit Rai, Inc.</div>
      </div>
    </FooterElement>
  );
};
